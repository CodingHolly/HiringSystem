<template>
  <div class="main-content">
    ...
    <div style="display: flex">
      <div class="left"></div>
      <div style="width:70%;background-color: white;height: 700px">
        <div style="display: flex">
          <el-card style="margin: 50px 100px">
            ...
            <div>
              <el-form ref="form" :model="user" :inline="true">
                ...
                <el-form-item label="身份" prop="identity" style="margin-left: 35px">
                  <el-select v-model="user.identity" style="width: 150px;">
                    <el-option
